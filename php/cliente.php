...
if (isset($_SESSION["rut_persona"])) {
	...
	if (isset($_POST["rutBuscar"])) {
		...
		$sql = "SELECT * from cliente where rut_persona like '$rutBuscar%' and estado_persona = true ";
		...
		if ($_POST["apellidoPBuscar"] == "") {
			...
			$sql = "SELECT * from cliente where apellidop_persona like CONCAT('$apellidoPBuscar','%') and estado_persona = true ";
	...
	$totalquery = 0;
	if(!$_GET){
		header('Location: cliente.php?pagina=1');
	}
	...
	<body>
		...
		<header class="site-header sticky-top py-1" style="height: 95px;">
			<nav class="container d-flex flex-column flex-md-row justify-content-between">
				...
				<h2 class="letrah2" style="text-align: center;">CLIENTES <p style="text-transform: uppercase;height: 0px;"><?php foreach ($resultado1 as $row1){echo $row1["nombre_sucursal"];} ?></p></h2>
				<div class="dropdown">
				...
				<div class="table-wrapper">
					<div class="table-title">
						<div class="row primero">
							...
							<div class="col-sm-6">
								<a class="btn btn-primary b2" href="clienteRecuperar.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
									...
									<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											...
											<div class="row segundo">
												<div class="col-sm-6">
													<form action="cliente.php?pagina=1" method="POST" class="d-flex">
					...
					<div class="clearfix">
						...
						<ul class="pagination">
							<li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>"><a href="cliente.php?pagina=<?php echo $_GET['pagina'] - 1 ?>" class="page-link">Anterior</a></li>
							<?php for ($i = 0; $i < $paginasElevado; $i++) : ?>
								<li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>">
									<a href="cliente.php?pagina=<?php echo $i + 1 ?>" class="page-link"><?php echo $i + 1 ?></a>
								</li>
							<?php endfor ?>
							<li class="page-item <?php echo $_GET['pagina'] >= $paginasElevado ? 'disabled' : '' ?>"><a href="cliente.php?pagina=<?php echo $_GET['pagina'] + 1 ?>" class="page-link">Siguiente</a></li>
						</ul>
					</div>
				</div>
			</div>
...
-->
				...
				<form action="updateCliente.php" method="POST">
					<div class="modal-body">
						<div class="form-group form">
							...
							<div class="form-group">
								<label>Teléfono: </label>
								<input type="number" class="form-control c" id="updateTelefonoCliente" name="updateTelefonoCliente" required value="" maxlength="16">
							</div>
						</div>
					</div>
					<div class="modal-footer">
	...
	<script>
		//$('#sexoupdate<?php //echo $row['rut'] 
						?> option[id="<?php //echo $row['sexo'] 
										?>"]').attr("selected", true);
