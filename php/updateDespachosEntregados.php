...
/*$sql="UPDATE cliente SET rut='$rut', nombre='$nombre', apellidoP='$apellidoP',
 ...
 WHERE rut='$rut'";
 */
$sql = "SELECT updateDespachosEntregados('".$idUpdateDespacho."','".$updatePatente."', '".$updateInformacion."', '".$updateFechaLimite."', '".$updateFechaEntrega."', '".$updateProcesoDespacho."')";
echo $conn->exec($sql);

if($conn){
    Header("Location: despachosEntregados.php");
}
