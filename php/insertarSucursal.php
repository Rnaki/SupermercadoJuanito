...
if(isset($columnas) == 1){
    Header("Location: sucursalGerente.php?error=2");
}else{

}

//en $sql se guarda el insert
$sql=" SELECT insertarSucursal('".$id_sucursal."', '".$id_bodega."', '".$region_sucursal."', '".$comuna_sucursal."', '".$calle_sucursal."', '".$numero_calle_sucursal."', '".$fono_sucursal."', '".$nombre_sucursal."', '".$cantidad_trabajadores."')";
