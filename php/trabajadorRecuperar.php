	...
	<body>
		...
		<header class="site-header sticky-top py-1" style="height: 86px;">
			<nav class="container d-flex flex-column flex-md-row justify-content-between">
				...
				<h2 style="text-align: center;">ÁREA RECURSOS HUMANOS <P style="text-transform: uppercase;height: 0px;"><?php foreach ($resultado1 as $row1) {echo $row1["nombre_sucursal"];} ?></P></h2>
