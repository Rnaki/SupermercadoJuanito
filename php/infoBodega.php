                    ...
                    <form method="POST" action="insertarInfoBodega.php">
                        <div class="modal-body">
                            <div class="form-group ">
                                ...
                                <div class="form-group">
                                    <label>Stock: </label>
                                    <input type="number" class="form-control" name="stock" id="ingresarStock" required>
                                    <?php
                                    foreach ($resultado1 as $row1) {
                    ...
                    <div class="modal-body">
                        <form method="POST" action="updateInfoBodega.php">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Stock: </label>
                                    <input type="number" class="form-control" name="updateStock" id="updateStock" required>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header eli">
                        <h5 class="modal-title" id="exampleModalLabel">Quitar Stock Producto</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>¿Estas seguro que quieres quitar los stocks de este producto?</label>
