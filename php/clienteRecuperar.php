...
if (isset($_SESSION["rut_persona"])) {
	...
	$totalquery = 0;
	if(!$_GET){
		header('Location: clienteRecuperar.php?pagina=1');
	}
			...
			<div class="table-responsive">
				<div class="table-wrapper">
									...
									<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											...
											<div class="row segundo">
												<div class="col-sm-6">
													<form action="clienteRecuperar.php?pagina=1" method="POST" class="d-flex">
					...
					<div class="clearfix">
						...
						<ul class="pagination">
							<li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>"><a href="clienteRecuperar.php?pagina=<?php echo $_GET['pagina'] - 1 ?>" class="page-link">Anterior</a></li>
							<?php for ($i = 0; $i < $paginasElevado; $i++) : ?>
								<li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>">
									<a href="clienteRecuperar.php?pagina=<?php echo $i + 1 ?>" class="page-link"><?php echo $i + 1 ?></a>
								</li>
							<?php endfor ?>
							<li class="page-item <?php echo $_GET['pagina'] >= $paginasElevado ? 'disabled' : '' ?>"><a href="clienteRecuperar.php?pagina=<?php echo $_GET['pagina'] + 1 ?>" class="page-link">Siguiente</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<div class="modal fade" id="eliminarexampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<label style="font-size: 16px;">¿Desea recuperar este cliente?</label>
