                ...
                <form action="updateCliente.php" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group form">
                            ...
                            <div class="form-group">
                                <label>Nombre: </label>
                                <input type="text" class="form-control c" name="nombre" required value="<?php echo $row['nombre'] ?>" maxlength="32">
                            </div>
                            <div class="form-group">
                                <label>Apellido Paterno: </label>
                                <input type="text" class="form-control c" name="apellidoP" required value="<?php echo $row['apellidop'] ?>" maxlength="32">
                            </div>
                            <div class="form-group">
                                <label>Apellido Materno: </label>
                                <input type="text" class="form-control c" name="apellidoM" required value="<?php echo $row['apellidom'] ?>" maxlength="32">
                            </div>
                            <div class="form-group">
                                <label>Region: </label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control c" name="Contraseña" required value="<?php echo $row['contraseña'] ?>" maxlength="12">
                            </div>
                            <div class="form-group">
                                <label>Correo: </label>
                                <input type="text" class="form-control c" name="Correo" required value="<?php echo $row['correo'] ?>" maxlength="64">
                            </div>
                            <div class="form-group">
                                <label>Teléfono: </label>
                                <input type="text" class="form-control c" name="Telefono" required value="<?php echo $row['teléfono'] ?>" maxlength="16">
                            </div>
                        </div>
                    </div>
