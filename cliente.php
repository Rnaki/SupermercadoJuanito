				...
				<div class="table-title">
					<div class="row primero">
						...
						<div class="col-sm-6">
							...
							<?php include("modalAñadirCliente.php"); ?>
						</div>
					</div>
								...
								<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
									<div class="accordion-body">
										...
										<div class="row segundo">
											<div class="col-sm-6">
												<form action="cliente.php" method="POST" class="d-flex">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a href="#?id=<?php echo $row['rut'] ?>" class="edit" data-bs-toggle="modal" data-backdrop="static" data-keyboard="false" data-bs-target="#edicionexampleModal<?php echo $row['rut']; ?>"><i class="material-icons" data-toggle="tooltip" title="Editar" >&#xE254;</i></a>
									<a href="#?id=<?php echo $row['rut'] ?>" class="delete" data-bs-toggle="modal" data-bs-target="#eliminarexampleModal<?php echo $row['rut'] ?>"><i class="material-icons" data-toggle="tooltip" title="Eliminar">&#xE872;</i></a>
								</td>
							</tr>
